console.log(
  "Built over 2 days from 15/5/2020 to 16/5/2020 with addition of game over + reset in 20/10/2020."
);
var grid = [];
var score = 0;
...
function checkGameOver(grid) {
  for (var y = 1; y < grid.length; y++) {
    //start at 1 so corner cases not affected
